        ...
        <div class="column">
            <?php 
                if($url[1]!=""){
                    ...
                    //error de lista de produictos devido al id que se pasa por la url ya que la  paginaicon tambien se muestra en la url
                    echo $inscategoria->listarProductoControlador($url[2],5,$url[0],"", $url[1]);
                }else{
