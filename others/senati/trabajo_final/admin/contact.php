...
<html>
<head>
<title>Hotel | Contactos informacion</title>
...
<!---->
  <div class="grid-form1">
  	       <h3>Actualizar informacion de contacto</h3>
<?php 
...
<div class="form-group">
								...
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Horario de apertura</label>
									<div class="col-sm-8">
...
<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Correo Id</label>
									<div class="col-sm-8">
...
<div class="form-group">
			...
			<div class="col-sm-8 col-sm-offset-2">
				<button type="submit" name="update" class="btn-primary btn">Actualizar</button>
			</div>
		</div>
