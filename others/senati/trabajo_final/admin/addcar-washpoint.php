						...
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" name="washingpoint" method="post" enctype="multipart/form-data">
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Nombre Sucursal</label>
									<div class="col-sm-8">
										<input type="text" class="form-control" name="washingpointname" id="washingpointname" placeholder="Nombre de Sucursal" required>
									</div>
								</div>
<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Direccion</label>
									<div class="col-sm-8">
										<textarea class="form-control" name="address" id="address" placeholder="Ingrese Direccion" required rows="4"></textarea>
									</div>
								</div>

<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Numero de contacto</label>
									<div class="col-sm-8">
										<input type="text" class="form-control" name="contactno" id="contactno" placeholder="Ingrese numero telefonico" required>
									</div>
								</div>
			...
			<div class="col-sm-8 col-sm-offset-2">
				<button type="submit" name="submit" class="btn-primary btn">Agregar</button>

				<button type="reset" class="btn-inverse btn">Resetear</button>
			</div>
		</div>
