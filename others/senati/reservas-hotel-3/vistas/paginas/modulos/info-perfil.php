					...
					<?php if ($validarPagoReserva): ?>
							  	...
							  	<div class="card-footer d-flex bg-white">
							 		...
							 		<form action="<?php echo $ruta.'perfil'; ?>" method="POST" class="pt-3">
									  <script
									    ...
									    data-public-key="TEST-30abd844-70ac-4ab0-972b-8e2cae1d07bb"
							...
							if(isset($_REQUEST["token"])){
								...
								$issuer_id = $_REQUEST["issuer_id"];
							  	...
							  	MercadoPago\SDK::setAccessToken("TEST-8594342671792005-081317-b641064702ce7f1bd5d9646e360b7890-573032238");
					...
					<div class="col-12 mt-3">
					    ...
					    <tbody>
					     ...
					     echo '<p class="help-block small">
							...
							<a href="https://api.whatsapp.com/send?phone=+51 917744685&text=Hola Hotel Paracas, necesito hacer un cambio en una reserva" target="_blank">+51 917744685</a>
